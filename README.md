...
- [Go complete](#go-complete)
  ...
  - [Rest Api](#rest-api)
    ...
    - [Login route start](#login-route-start)
    - [Login route finish](#login-route-finish)
    - [Generating JWT](#generating-jwt)
    - [Finishing token](#finishing-token)
    ...
    - [Registring users](#registring-users)
    - [Cancelling registration](#cancelling-registration)
